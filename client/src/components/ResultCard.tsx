...
${idea.roadmap.map((r, i) => `${i + 1}. ${r}`).join('\n')}
  ...
  return (
    <div className="w-full max-h-full flex flex-col">
      <div className="glass-card rounded-2xl overflow-hidden flex flex-col border-t-4 border-t-accent shadow-2xl shadow-accent/5 max-h-full">
        ...
        <div className="p-6 md:p-8 pb-4 shrink-0">
          ...
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-foreground line-clamp-2">
            {idea.title}
          </h2>
          <p className="mt-3 text-base md:text-lg text-muted-foreground leading-relaxed line-clamp-3">
            {idea.problemStatement}
          </p>
        </div>

        {/* Content Tabs */}
        <div className="flex-1 min-h-0 bg-background/40 flex flex-col overflow-hidden">
          <Tabs defaultValue="overview" className="flex-1 flex flex-col overflow-hidden">
            <div className="px-6 md:px-8 pt-2 border-b border-white/5 shrink-0">
              <ScrollArea className="w-full">
                <TabsList className="bg-transparent h-auto p-0 gap-4 md:gap-6 flex whitespace-nowrap">
                  ...
                  {idea.codeTemplates && idea.codeTemplates.length > 0 && <TabTrigger value="templates" icon={FileCode} label="Templates" />}
            ...
            <div className="flex-1 overflow-hidden relative">
              <ScrollArea className="h-full">
                <div className="p-6 md:p-8">
                  <TabsContent value="overview" className="mt-0 space-y-6 md:space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                    {/* AI Specific Metrics */}
