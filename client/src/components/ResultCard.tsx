...
${idea.roadmap.map((r, i) => `${i + 1}. ${r}`).join('\n')}
  ...
  return (
    <div className="w-full flex flex-col my-4">
      <div className="glass-card rounded-2xl overflow-hidden flex flex-col border-t-4 border-t-accent shadow-2xl shadow-accent/5">
        ...
        {/* Content Tabs */}
        <div className="flex-1 bg-background/40 flex flex-col">
